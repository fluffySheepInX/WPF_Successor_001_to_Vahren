...
namespace WPF_Successor_001_to_Vahren._025_Parser
{
    ...
    public class Parser
    {
        ...
        private void RegisterPrefixParseFns()
        {
            ...
            this.PrefixParseFns.Add(TokenType.ISPLAYER, this.ParseSystemFunctionLiteral);
            this.PrefixParseFns.Add(TokenType.DISPLAYGAMERESULT, this.ParseSystemFunctionLiteral);
        }
